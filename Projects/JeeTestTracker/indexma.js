...
function getselectedvalue() {
  ...
  else if (selectedValue == "physicsa") {
    window.open('physicsa.html')
  }
  else if(selectedValue == "chemistrya"){
    window.open('chemistrya.html')
  }
  else if(selectedValue == "mathsa"){
    window.open('mathsa.html')
  }else if(selectedValue == "overalla"){
    window.open('test trackera.html')
  }
  else{
...
function loadTableData() {
  const savedData = JSON.parse(localStorage.getItem("testScoreTrackerma")) || [];
...
function saveTableData() {
  ...
  localStorage.setItem("testScoreTrackerma", JSON.stringify(data));
}
